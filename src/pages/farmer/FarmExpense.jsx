    ...
    <div className="p-6 md:p-10 font-poppins bg-gray-50 min-h-screen text-gray-800">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-3">
          <Wallet size={38} className="text-green-700" />
          <div>
            <h1 className="text-3xl font-bold text-gray-900">
              Farm Expense Tracker 💰
            </h1>
            <p className="text-gray-600 text-base">
              Manage and monitor your daily farm expenses easily.
            </p>
          </div>
        </div>
        <button
          onClick={generatePDF}
          className="flex items-center gap-2 bg-white border border-green-400 text-green-700 px-4 py-2 rounded-lg text-sm font-semibold hover:bg-green-50 shadow-sm"
        >
      ...
      {loading ? (
        ...
        <>
          {/* Expense Form */}
          <div className="bg-white border border-green-300 rounded-xl shadow p-6 mb-8">
            ...
            <button
              onClick={addExpense}
              className="mt-5 flex items-center gap-2 bg-green-700 hover:bg-green-800 text-white px-5 py-2 rounded-lg font-semibold"
            >
          ...
          {/* Expense Table */}
          <div className="bg-white border border-green-300 rounded-xl shadow p-6 mb-8 overflow-x-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white border border-green-300 rounded-xl shadow p-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-3 flex items-center gap-2">
                <BarChart3 size={18} className="text-green-700" /> Category Summary
              </h2>
            ...
            <div className="bg-white border border-green-300 rounded-xl shadow p-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-3 flex items-center gap-2">
                <PiggyBank size={18} className="text-green-700" /> AI Spending Tip
              </h2>
              {totalExpense > 10000 ? (
                <p className="text-sm text-gray-700">
                  ⚠️ Your total spending this month is higher than average. Review
                  feed and fuel costs for possible optimizations.
                </p>
              ) : totalExpense > 0 ? (
                <p className="text-sm text-gray-700">
                  ✅ Spending is under control. Continue regular monitoring.
                </p>
              ) : (
