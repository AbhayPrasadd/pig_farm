      ...
      <div className="bg-white shadow-sm border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-center">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl font-semibold text-gray-800">Biosecurity Advisor</h1>
              <p className="text-sm text-gray-500">
                Your intelligent farm biosecurity assistant
              </p>
            </div>
          </div>
        </div>
        ...
        {chat.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <p className="text-gray-500 max-w-md">
              Ask me anything about biosecurity, disease prevention, hazard
              control, or safety management in farms. You can type or use voice input.
            </p>
          </div>
        )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="md:col-span-3">
              <textarea
                ...
                placeholder="Ask your biosecurity-related question here... (Press Enter to send)"
              />
            </div>
